...
class LLMModel:
    ...
    def query_hf(self, prompt, max_new_tokens=1000):
        ...
        for physician_key, physician in physician_descriptions.items():
            for tone_key, tone in tones.items():
                ...
                prompt = (
                    ...
                    "ONLY REPLY WITH THE ANSWER like Answer: \n\n"
                    f"Scenario: {question}\n\n"
                    "Choices:\n"
...
def run_evaluation(file_path, output_dir, model_name, gpu):
    results = []
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = "./result/llama1file"
    test_model_name = "meta-llama/Llama-3.1-8B-Instruct"
    run_evaluation(DATA_DIR, OUTPUT_DIR, test_model_name, 0)
